...
class SentimentResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'post_date', 'image_results', 'source_type'
        ]
...
class SentimentAnalysisSerializer(serializers.ModelSerializer):
    ...
    source = serializers.ListField(
        child=serializers.ChoiceField(choices=[c[0] for c in SentimentAnalysis.SOURCE_CHOICES]),
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'query', 'source', 'model', 'subreddits',
            'start_date', 'end_date', 'status', 'created_at', 'updated_at', 'results',
            'include_images'
        ]
...
class SentimentAnalysisCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SentimentAnalysis
        fields = [
            'id', 'query', 'source', 'model', 'selected_llms', 'subreddits',
            'start_date', 'end_date', 'include_images'
        ]
