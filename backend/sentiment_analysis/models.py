...
class SentimentAnalysis(models.Model):
    ...
    def __str__(self) -> str:
        ...
        sources = ','.join(self.source) if isinstance(self.source, list) else self.source
...
class SentimentResult(models.Model):
    ...
    """
    sentiment_analysis = models.ForeignKey(SentimentAnalysis, on_delete=models.CASCADE, related_name='results')
    ...
    override_by = models.ForeignKey('auth.User', null=True, blank=True, on_delete=models.SET_NULL)

    # Source-specific fields
    source_type = models.CharField(max_length=50, default='reddit')  # 'reddit' or 'twitter'
...
class ImageSentimentResult(models.Model):
    sentiment_result = models.ForeignKey(SentimentResult, on_delete=models.CASCADE, related_name='image_results')
